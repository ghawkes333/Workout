...
async function InitDB(){
    ...
    let names = ["V-Up", "Wide-Grip Push-Up", "Air Squats", "Push-Up", "Standing Alternating Dumbbell Curl", "Romanian Dumbbell Deadlift", "Incline Bench Press", "Barbell Squat", "Deadlift", "Burpees", "Crunches (touch-heels)", "High Knee (running in place)", "Crunches (touch heels)", "Close-grip Push-Up", "Forward Lunge", "Incline Dumbbell Bench Press", "Dumbbell Lunge", "Bent-Over Dumbbell Row", "Romanian Barbell Deadlift", "Squat Jumps", "Front Plank", "Bench Dips", "Jumping Lateral Skaters", "Arnold Dumbbell Press", "Dumbbell Side Lunge", "Overhead Press", "Barbell Lunge", "Incline Press", "Mountain Climbers", "Burpees with Pushup", "Box Jumps", "Flat Dumbbell Fly", "Dumbbell Squat", "Barbell Curl", "Alternating Lunge Jumps"]
